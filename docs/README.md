...
The deployment url is: [https://cidinene.github.io/asw2122_0/](https://cidinene.github.io/asw2122_0/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://cidinene.github.io/asw2122_0/](https://cidinene.github.io/asw2122_0/) we need to execute `npm run deploy`.
